...
class _SignupUserState extends State<SignupUser> {
  ...
  void validateAndSubmit() {
    ...
    print("🎉 SUBMITTED SUCCESSFULLY 1!");
    // If success → call API
    registerDriver();
    print("🎉 SUBMITTED SUCCESSFULLY 2!");
  }
...
// UPLOAD BOX (FRONT & BACK)
  ...
  void registerDriver() async {
    _showLoader();
    try {
      final res = await AuthService.userRegister(
      ...
      if (res["result"] == "success" || res["status"] == true) {
      ...
      print('❌ Login error: $e');
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Error get: $e")),
      );
    }
  }
